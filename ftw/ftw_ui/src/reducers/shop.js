...
const shop = (state = INITIAL_STATE, action) => {
    switch (action.type) {
        case GET_PRODUCTS:
            return Object.assign(Object.assign({}, state), { products: action.products });
        case ADD_TO_CART:
        case REMOVE_FROM_CART:
        case CHECKOUT_SUCCESS:
            return Object.assign(Object.assign({}, state), { products: products(state.products, action), cart: cart(state.cart, action), error: '' });
        case CHECKOUT_FAILURE:
            return Object.assign(Object.assign({}, state), { error: 'Checkout failed. Please try again' });
        default:
            return state;
    }
};
...
const products = (state, action) => {
    switch (action.type) {
        ...
        case REMOVE_FROM_CART:
            ...
            return Object.assign(Object.assign({}, state), { [productId]: product(state[productId], action) });
        default:
            return state;
    }
};
const product = (state, action) => {
    switch (action.type) {
        case ADD_TO_CART:
            return Object.assign(Object.assign({}, state), { inventory: state.inventory - 1 });
        case REMOVE_FROM_CART:
            return Object.assign(Object.assign({}, state), { inventory: state.inventory + 1 });
        default:
            return state;
...
const cart = (state, action) => {
    switch (action.type) {
        case ADD_TO_CART:
            ...
            return Object.assign(Object.assign({}, state), { [addId]: (state[addId] || 0) + 1 });
        case REMOVE_FROM_CART:
            ...
            if (quantity <= 0) {
                ...
                return Object.assign(Object.assign({}, state), { [removeId]: quantity });
            }
        case CHECKOUT_SUCCESS:
            return {};
        default:
